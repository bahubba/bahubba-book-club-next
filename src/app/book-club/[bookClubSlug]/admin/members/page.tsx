 ...
 */
const BookClubAdminMembersTableWrapper = async ({ bookClubSlug }: Readonly<{ bookClubSlug: string }>) => {
 ...
 */
const BookClubAdminMembersPage = ({ params: { bookClubSlug } }: Readonly<BookClubAdminMembersPageProps>) => (
  <Suspense
    fallback={
